...
const menuItems = [
    ...
    { nume: "Supplì", pret: 5, categorie: "Restaurant", descriere: "Antipasti | crochete de orez cu mozzarella" },
    { nume: "Bruschetta Pomodoro", descriere: "Antipasti | roșii, usturoi, busuioc, ulei de măsline", pret: 5, categorie: "Restaurant" },
    { nume: "Chipsuri", pret: 5, categorie: "Restaurant", descriere: "Antipasti | chipsuri de cartofi făcute în casă" },
    { nume: "Legume la grătar", pret: 10, categorie: "Restaurant", descriere: "Fel Principal | dovlecei, ardei, ciuperci, vinete la grătar" },
    { nume: "Scaloppina al Limone", pret: 35, categorie: "Restaurant", descriere: "Fel Principal | gătită cu sos proaspăt de lămâie" },
    { nume: "Platou aperitiv (2 pers.)", pret: 40, categorie: "Restaurant", descriere: "Antipasti | mezeluri și brânzeturi tradiționale italiene" },
    ...
    { nume: "Cheesecake", pret: 15, categorie: "Restaurant", descriere: "Desert | prăjitură cu cremă de brânză și sos de fructe" },
    { nume: "Tiramisu", pret: 20, categorie: "Restaurant", descriere: "Desert | pișcoturi, mascarpone, espresso și cacao" },
    { nume: "Gumă de mestecat Mentos", pret: 10, categorie: "Restaurant", descriere: "Desert | gumă de mestecat drajeuri" },

    { nume: "Betty Blue Vanilie", pret: 5, categorie: "Restaurant", descriere: "Înghețată | înghețată cremoasă de vanilie" },
    { nume: "Betty Blue Tiramisu", pret: 5, categorie: "Restaurant", descriere: "Înghețată | aromă de tiramisu" },
    { nume: "Betty Blue Triple Chocolate", pret: 5, categorie: "Restaurant", descriere: "Înghețată | trei tipuri de ciocolată" },
    { nume: "Betty Blue Chocolate", pret: 5, categorie: "Restaurant", descriere: "Înghețată | ciocolată intensă" },
    { nume: "Betty Blue Fistic", pret: 5, categorie: "Restaurant", descriere: "Înghețată | înghețată fină de fistic" },
    { nume: "Betty Blue Bubble Gum", pret: 5, categorie: "Restaurant", descriere: "Înghețată | aromă de guma de mestecat" },
    { nume: "Cornet Scufița Roșie", pret: 5, categorie: "Restaurant", descriere: "Înghețată | cornet cu sos de fructe roșii" },
    { nume: "Napoca Cornet Cacao", pret: 6, categorie: "Restaurant", descriere: "Înghețată | cornet cu cremă de cacao" },
    { nume: "Napoca Pahar Cacao", pret: 6, categorie: "Restaurant", descriere: "Înghețată | pahar cu înghețată de cacao" },
    { nume: "Napoca Pahar Vanilie", pret: 6, categorie: "Restaurant", descriere: "Înghețată | pahar cu înghețată de vanilie" },
    { nume: "Twister Green", pret: 7, categorie: "Restaurant", descriere: "Înghețată | înghețată de fructe pe băț" },
    { nume: "Calippo Căpșuni", pret: 8, categorie: "Restaurant", descriere: "Înghețată | înghețată răcoritoare de căpșuni" },
    { nume: "Cornetto King Cone Vanilie", pret: 12, categorie: "Restaurant", descriere: "Înghețată | cornet mare cu vanilie" },
    { nume: "Cornetto King Cone Ciocolată", pret: 15, categorie: "Restaurant", descriere: "Înghețată | cornet mare cu ciocolată" },
    { nume: "Magnum Migdale", pret: 15, categorie: "Restaurant", descriere: "Înghețată | ciocolată cu lapte și migdale" },
    { nume: "Magnum Piersică", pret: 15, categorie: "Restaurant", descriere: "Înghețată | ciocolată albă și piersică" },
